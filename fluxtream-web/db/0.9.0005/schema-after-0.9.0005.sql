...
CREATE TABLE `ApiUpdates` (
  ...
  KEY `api` (`api`),
  KEY `success` (`success`)
) ENGINE=MyISAM AUTO_INCREMENT=43082 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=6687 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitActivity` (
  ...
  KEY `guestId_index` (`guestId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=16264 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_FitbitSleep` (
  ...
  KEY `guestId_index` (`guestId`),
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=17403 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Facet_GoogleLatitudeLocation` (
  ...
  KEY `timeUpdated_index` (`timeUpdated`)
) ENGINE=MyISAM AUTO_INCREMENT=280182 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ScheduledUpdate` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=36712 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=42875 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-12-09 15:44:06
