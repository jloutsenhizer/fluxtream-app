...
public class BodyTrackController {
    ...
    public Response getFacetMetadata(@PathParam("UID") Long uid,
        ...
        setTransactionName(null, "POST /metadata/{UID}/" + deviceNickname + "." + channelName + "/{facetId}/set");
        ...
        if (comment != null || tags != null) {
            return executeFacetMetaDataOperation(uid, deviceNickname, channelName, facetId, new FacetMetaDataOperation() {
                ...
                public Response executeOperation(@NotNull final AbstractFacet facet) {
                    ...
                    final AbstractFacet modifiedFacet = apiDataService.createOrReadModifyWrite(facet.getClass(), facetMetadataModifier.getFacetFinderQuery(), facetMetadataModifier);
    ...
    private Response executeFacetMetaDataOperation(final long uid,
            ...
            if (connector != null) {
                ...
                if (accessAllowed) {
                    ...
                    if (objectType != null) {
                        final AbstractFacet facet = apiDataService.getFacetById(uid, connector, objectType, facetId);
                        if (facet != null) {
                            try {
    ...
    private static final class FacetMetadataModifier implements ApiDataService.FacetModifier<AbstractFacet> {
        ...
        @Override
        public AbstractFacet createOrModify(final AbstractFacet existingFacet) {
